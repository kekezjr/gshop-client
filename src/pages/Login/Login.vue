          ...
          <div :class="{on: !loginWay}">
            <section>
              ...
              <section class="login_message">
                ...
                <img class="get_verification" src="./images/captcha.svg" alt="captcha"  ref='captcha' @click="updataCaptcha">
              </section>
            </section>
          </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 更新验证码图片
      updataCaptcha () {
        //  一旦给img指定新的src值, 浏览器就会自动发请求获取数据显示为图片  (添加时间戳参数  当前时间值)
